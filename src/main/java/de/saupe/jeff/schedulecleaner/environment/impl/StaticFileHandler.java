...
//stolen code from https://github.com/ianopolous/simple-http-server/blob/master/src/http/StaticHandler.java
public class StaticFileHandler implements HttpHandler
{
    ...
    public StaticFileHandler(String pathToRoot, boolean caching, boolean gzip) throws IOException {
